...
typedef OnPreOrderAdd = void Function(
  MenuItemModel item,
  MenuItemVariantModel? variant,
  int quantity,
);

Future<void> showPreOrderItemSheet({
  required BuildContext context,
  required MenuItemModel item,
  required OnPreOrderAdd onAdd,
}) {
  return showModalBottomSheet(
    ...
    builder: (context) {
      return FractionallySizedBox(
        heightFactor: 0.8,
        child: _PreOrderFoodDetailContent(item: item, onAdd: onAdd),
      );
    },
  );
}

class _PreOrderFoodDetailContent extends StatefulWidget {
  final MenuItemModel item;
  final OnPreOrderAdd onAdd;

  const _PreOrderFoodDetailContent({required this.item, required this.onAdd});

  @override
  State<_PreOrderFoodDetailContent> createState() => _PreOrderFoodDetailContentState();
}

class _PreOrderFoodDetailContentState extends State<_PreOrderFoodDetailContent> {
  ...
  void _add() {
    widget.onAdd(widget.item, _selectedVariant, _quantity);
              ...
              children: [
                ...
                Expanded(
                  child: ElevatedButton(
                    ...
                    child: Text(
                      'Add · Rs. ${_total.toStringAsFixed(0)}',
